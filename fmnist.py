...
parser = argparse.ArgumentParser(description='Image Classification - FashionMNIST')
...
hyper.add_argument('--decay-rate', default=.5, type=float)
...
trainset = FashionMNIST(root=args.data_dir, train=True, download=False, transform=transform_tr)
trainloader = DataLoader(trainset, batch_size=args.batch_size, shuffle=True, num_workers=2)
testset = FashionMNIST(root=args.data_dir, train=False, download=False, transform=transform_ts)
