...
parser.add_argument('--ckpt-tag', default='roberta', type=str)
...
if args.empty:
	net = RobertaForMaskedLM(config).to(device)
else:
	net = RobertaForMaskedLM.from_pretrained(args.pretrained).to(device)
